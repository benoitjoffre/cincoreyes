...
const fr = {
  ...
  "lobby.host": "Hôte",
  "lobby.ready": "Prêt",
  "player.awayCountdown": "Absent · {seconds} s",
  "player.kickCountdown": "Exclure dans {seconds} s",
  "player.kick": "Exclure {name}",
  ...
  "error.KICK_HOST_ONLY": "Seul l’hôte peut exclure un joueur.",
  "error.CANNOT_KICK_SELF": "Vous ne pouvez pas vous exclure vous-même.",
  "error.PLAYER_CONNECTED": "Ce joueur est actuellement connecté.",
  "error.KICK_TOO_EARLY": "Ce joueur peut encore rejoindre la partie.",
  ...
  "error.INVALID_EMOJI": "Emoji invalide.",
  "error.INVALID_TARGET": "Tu ne peux pas t’envoyer un emoji à toi-même.",
...
const es: Record<TranslationKey, string> = {
  ...
  "lobby.ready": "Listo",
  "player.awayCountdown": "Ausente · {seconds} s",
  "player.kickCountdown": "Expulsar en {seconds} s",
  "player.kick": "Expulsar a {name}",
  ...
  "error.KICK_HOST_ONLY": "Solo el anfitrión puede expulsar a un jugador.",
  "error.CANNOT_KICK_SELF": "No puedes expulsarte a ti mismo.",
  "error.PLAYER_CONNECTED": "Este jugador está conectado actualmente.",
  "error.KICK_TOO_EARLY": "Este jugador todavía puede volver a la partida.",
  ...
  "error.INVALID_EMOJI": "Emoji no válido.",
  "error.INVALID_TARGET": "No puedes enviarte un emoji a ti mismo.",
